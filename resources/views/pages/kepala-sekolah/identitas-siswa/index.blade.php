...
>>>>>>> julio
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="/identitas-siswa/{{ $item->id }}">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <a href="/identitas-siswa/{{ $item->id }}/edit">
                                                ...
                                                <div class="ms-2 d-flex flex-column justify-content-center">
                                                    <form action="/identitas-siswa/{{ $item->id }}" method="POST" role="form text-left">
                                                        @csrf
                                                        @method('DELETE')
