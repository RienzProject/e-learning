            ...
            <div class="card z-index-2">
                <div class="card-body p-3">
                    <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                        <div class="chart">
                            <canvas id="pie-chart" class="chart-canvas" height="170"></canvas>
                        </div>
                    </div>
                    <h6 class="ms-2 mt-4 mb-0">Jumlah Siswa Berdasarkan Jenis Kelamin</h6>
                        ...
                        <div class="row">
                            @foreach ($genderLabels as $index => $label)
                                <div class="col-6 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder" style="color: {{ $genderColors[$index] }};">
                                        {{ $genderData[$index] }}</h4>
                                </div>
                            @endforeach
                        </div>
