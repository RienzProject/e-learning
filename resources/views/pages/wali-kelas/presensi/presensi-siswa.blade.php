    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">Presensi Siswa -
                    {{ \Carbon\Carbon::parse($ruangPresensi->tanggal_presensi)->isoFormat('dddd, D MMMM YYYY') }}</h6>
            </div>
                            ...
                            <table id="myTable" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-xs font-weight-bolder">Input Presensi</th>
                                                ...
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <h6 class="mb-0 text-sm">
                                                            {{ $presensi->status_presensi ?? 'Belum Diisi' }}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
