                        ...
                        <table id="myTable" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-xs font-weight-bolder">Predikat</th>
                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $item->predikat ?? '-' }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center me-2">
                                                    <a
                                                        href="/ekstrakulikuler-siswa/{{ $item->id }}/input-catatan-siswa">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <form action="/ekstrakulikuler-siswa/{{ $ekstrakulikuler->id }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        ...
                                                        <button type="submit" class="btn bg-gradient-danger">
                                                            ...
                                                            Hapus Siswa di Ekstrakulikuler ini
                                                        </button>
                                                    </form>
                                                </div>
                                            </div>
