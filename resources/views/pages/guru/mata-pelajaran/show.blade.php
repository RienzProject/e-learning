    ...
    <div>
        <div class="text-end">
            <a href="{{ route('upload-tugas', $mataPelajaran->id) }}">
                <button type="button" class="btn bg-gradient-info">Upload Tugas</button>
            </a>
        </div>
        <div class="py-1">
                        ...
                        <table id="myTable" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-xs font-weight-bolder">Jenis Tugas</th>
                                ...
                                @foreach ($data as $index => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $item->jenis_nilai }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <a href="{{ route('get-list-tugas-siswa', $item->id) }}">
