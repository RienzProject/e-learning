<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3"
    ...
    <div class="collapse navbar-collapse h-auto w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard-wali-kelas') ? 'active' : '' }}"
                    href="{{ url('dashboard-wali-kelas') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('nilai-siswa') ? 'active' : '' }} " href="{{ url('nilai-siswa') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('ekstrakulikuler-siswa') ? 'active' : '' }} "
                    href="{{ url('ekstrakulikuler-siswa') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-people" viewBox="0 0 16 16">
        ...
        <a class="nav-link {{ Request::is('jadwal-kelas') ? 'active' : '' }} " href="{{ url('jadwal-kelas') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('kelola-ruang-presensi') ? 'active' : '' }} "
                    href="{{ url('kelola-ruang-presensi') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <a class="nav-link {{ Request::is('kenaikan-kelas') ? 'active' : '' }} " href="{{ url('kenaikan-kelas') }}">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('rapor-siswa') ? 'active' : '' }} "
                    href="{{ url('rapor-siswa') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
