...
class Siswa extends Model
{
    ...
    protected $fillable = ['kelas_semester_id', 'kelas_semester_sebelumnya_id', 'nama', 'NIS', 'NISN', 'jenis_kelamin', 'tempat_Lahir', 'tanggal_lahir', 'agama', 'pendidikan_sebelumnya', 'alamat', 'foto'];
